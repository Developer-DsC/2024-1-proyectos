...
public class cEstudiante {
     ...
     */
    public void nuevo(Estudiante e) throws IOException {
     ...
     * @throws java.io.IOException
     */
    public void modificar(Estudiante e, String ced) throws IOException {
     ...
     * @throws IOException
     */
    public cEstudiante buscar_cedula(String cedula) throws IOException {
        cEstudiante ob = new cEstudiante();
        for (int i = 0; i < Lista.size(); i++) {
            Estudiante e = getEstudiante(i);
     ...
     * @throws IOException
     */
    public cEstudiante buscar_apellido(String apellido) throws IOException {
        cEstudiante ob = new cEstudiante();
        for (int i = 0; i < Lista.size(); i++) {
            Estudiante e = getEstudiante(i);
    ...
    public void guardar() throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < Lista.size(); i++) {
                Estudiante ob = (Estudiante) Lista.get(i);

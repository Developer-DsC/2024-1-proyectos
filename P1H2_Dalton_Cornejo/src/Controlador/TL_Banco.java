...
public class TL_Banco {

    public static List<LO_Banco> ListaBanco = new ArrayList<LO_Banco>();

    public static void Insertar(LO_Banco op) {
        ListaBanco.add(op);
    }

    public static void Modificar(int pos, LO_Banco om) {
        ListaBanco.set(pos, om);
    }
    ...
    public static LO_Banco getFactura(int pos) {
    ...
    public static DefaultTableModel VisualizarLista() {
        ...
        for (int i = 0; i < ListaBanco.size(); i++) {
            Datos[0] = String.valueOf(ListaBanco.get(i).getId());
            Datos[1] = String.valueOf(ListaBanco.get(i).getNombre());
            Datos[2] = String.valueOf(ListaBanco.get(i).getSucursal());
            Datos[3] = String.valueOf(ListaBanco.get(i).getNumSucursal());
            Datos[4] = String.valueOf(ListaBanco.get(i).getTransaccion());
            Datos[5] = String.valueOf(ListaBanco.get(i).getMonto());
            dt.addRow(Datos);
        }
        return dt;
    }
    ...
    public static void LitA() {
        ...
        for (int i = 0; i < ListaBanco.size(); i++) {
            ...
            if (ListaBanco.get(i).getTransaccion().equals("D")) {
    ...
    public static void LitB() {
        ...
        for (int i = 0; i < ListaBanco.size(); i++) {
            if (ListaBanco.get(i).getTransaccion().equals("E")) {
                if (ListaBanco.get(i).getMonto() > aextraccion) {
                    aextraccion = ListaBanco.get(i).getMonto();
                    aCliente = ListaBanco.get(i).getNombre();
                    asucursal = ListaBanco.get(i).getSucursal();
                }
            }
    ...
    public static void LitC() {
        ...
        for (int i = 0; i < ListaBanco.size(); i++) {
            ...
            if (ListaBanco.get(i).getSucursal().equals("Virreyes")) {
                if (ListaBanco.get(i).getTransaccion().equals("D")) {
                    cont1++;
                }
                if (ListaBanco.get(i).getTransaccion().equals("E")) {
            ...
            if (ListaBanco.get(i).getSucursal().equals("San Fernando")) {
                if (ListaBanco.get(i).getTransaccion().equals("D")) {
                    cont2++;
                }
                if (ListaBanco.get(i).getTransaccion().equals("E")) {
            ...
            if (ListaBanco.get(i).getSucursal().equals("Tigre")) {
                if (ListaBanco.get(i).getTransaccion().equals("D")) {
                    cont3++;
                }
                if (ListaBanco.get(i).getTransaccion().equals("E")) {
    ...
    public static void LitD() {
        ...
        for (int i = 0; i < ListaBanco.size(); i++) {
            if (ListaBanco.get(i).getSucursal().equals("Virreyes")) {
                if (ListaBanco.get(i).getTransaccion().equals("D")) {
                    acum1 = acum1 + ListaBanco.get(i).getMonto();
                }
            }
            if (ListaBanco.get(i).getSucursal().equals("San Fernando")) {
                if (ListaBanco.get(i).getTransaccion().equals("D")) {
                    acum2 = acum2 + ListaBanco.get(i).getMonto();
                }
            }
            if (ListaBanco.get(i).getSucursal().equals("Tigre")) {
                if (ListaBanco.get(i).getTransaccion().equals("D")) {
                    acum3 = acum3 + ListaBanco.get(i).getMonto();
                }
            }
        }
    ...
    public static void LitF() {
        ...
        for (int i = 0; i < ListaBanco.size(); i++) {
            if (ListaBanco.get(i).getTransaccion().equals("E")) {
                if (ListaBanco.get(i).getMonto() > 500) {
                    anum = ListaBanco.get(i).getId();
                    Anom = ListaBanco.get(i).getNombre();

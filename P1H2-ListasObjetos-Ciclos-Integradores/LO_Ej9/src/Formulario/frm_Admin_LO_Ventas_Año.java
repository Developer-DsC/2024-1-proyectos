...
public class frm_Admin_LO_Ventas_Año extends javax.swing.JFrame {
     ...
     */
    public frm_Admin_LO_Ventas_Año() {
        initComponents();
        CargarDatos();
        VisualizarLista();
    ...
    public void CargarDatos() {
        ...
        TL_Ventas_Año.Insert(new LO_Ventas_Año(1, 10, 12, 2023, 10, 10));
        TL_Ventas_Año.Insert(new LO_Ventas_Año(2, 5, 12, 2023, 100, 100));
        TL_Ventas_Año.Insert(new LO_Ventas_Año(3,3,12,2023,20,20));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        frm_edit_Ventas_Año frm = new frm_edit_Ventas_Año();
        frm.setVisible(true);

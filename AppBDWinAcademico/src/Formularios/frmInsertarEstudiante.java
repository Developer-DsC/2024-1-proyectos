...
public class frmInsertarEstudiante extends javax.swing.JFrame {
    ...
    public frmInsertarEstudiante(String funcion) {
        initComponents();
      ...
      public void setDatos(Estudiante oe){
        ...
        jTextField1.setText(String.valueOf(oe.getIdCodigo()));
        ...
        jTextField6.setText(oe.getCiudad()); 
        jComboBox1.setSelectedItem(oe.getSexo()+"");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 140, -1));
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 120, 140, -1));
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 140, -1));
        jPanel1.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, 140, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 460, 290));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 410, 90, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!jTextField1.getText().equals("")&& jTextField2.getText() !="" && jTextField3.getText() !="" && jTextField4.getText() !="" && jTextField5.getText() !="" && jTextField6.getText() !=""   && jComboBox1.getSelectedIndex()>0)    
        {
        try{    
            ...
            String ciu= jTextField6.getText();
           
            Estudiante oe = new Estudiante(id,ced, nom, ape, sex, eda,ciu);
            if(funcion.equals("Insertar"))
            {
               edao.InsertarEstudiante(oe);
            }else{
               edao.ActualizarEstudiante(oe); 
            }
            frmAdminEstudiante.MostrarDatos("");
            this.dispose();
        }catch(Exception ex)
        {

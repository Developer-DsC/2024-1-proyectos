...
public class frm_Admin_LO_Ingreso_Universidad extends javax.swing.JFrame {
     ...
     */
    public frm_Admin_LO_Ingreso_Universidad() {
        initComponents();     
        CargarDatos();
        VisualizarLista();
    ...
    public void CargarDatos() {
        ...
        TL_Ingreso_Universidad.Insert(new LO_Ingreso_Universidad(1, "Utmach", 1, "Dalton", 1, 100));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        frm_edit_LO_Ingreso_Universidad frm =  new frm_edit_LO_Ingreso_Universidad();
        frm.setVisible(true);

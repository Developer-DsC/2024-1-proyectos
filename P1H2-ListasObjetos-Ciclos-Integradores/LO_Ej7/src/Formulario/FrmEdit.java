...
public class FrmEdit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 140, -1));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Comun", "Diferencial" }));
        getContentPane().add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 140, -1));
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 170, 140, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jComboBox1.getSelectedIndex() >= 0 && jComboBox2.getSelectedIndex() >= 0 && !jTextField1.getText().equals("") && !jTextField2.getText().equals("")) {
            int IdNumTick=Integer.parseInt(jTextField1.getText());
            ...
            EmpresaMicros oe = new EmpresaMicros(IdNumTick, Destino, Servicio, CantPasajes);
            Tlista.Insert(oe);

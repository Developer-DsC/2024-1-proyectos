...
public class frmInsertar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, 180, -1));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4" }));
        getContentPane().add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 180, -1));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 110, 180, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Suc = jComboBox2.getSelectedItem().toString();
        String nomClie = jTextField1.getText();
        double SaldClie = Double.parseDouble(jTextField2.getText());
        Cliente op = new Cliente(Zona, Suc, nomClie, SaldClie);
        TLista.Insert(op);
        frmAdmin.Listar();
        this.hide();

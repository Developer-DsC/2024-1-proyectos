...
public class FrmEdit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consumo Electrico");
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, 160, -1));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, 160, -1));
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 160, -1));
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 160, -1));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         String ubi = jComboBox1.getSelectedItem().toString();
            int Nclie = Integer.parseInt(jTextField1.getText());
            int ConsAnt = Integer.parseInt(jTextField2.getText());
            int ConsAct = Integer.parseInt(jTextField3.getText());
            Compañia op = new Compañia(ubi, Nclie, ConsAnt, ConsAct);       
            Tlista.Insert(op);
            this.hide();
            FrmAdmin.Listar();

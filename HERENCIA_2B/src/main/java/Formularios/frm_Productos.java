...
import Entidades.Caduca;
import Entidades.No_Caducadero;
...
public class frm_Productos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PRODUCTOS \"AKÍ\"");

        jLabel2.setText("Nombre del producto:");

        jLabel3.setText("Días para caducar del producto:");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Caducable", "No Caducable" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      Productos pro1 = new Productos(nom, pre, cant);
      System.out.print("prod 1");
      if(tipo==1){
          System.out.print("\nif 1");
          Caduca cad1 = new Caduca(dias, nom, pre, cant);
          cad1.Calcular(cant);
          cad1.imprimir();
      }
      ...
      if(tipo==2){
          System.out.print("\nif 2");
         No_Caducadero nocad1 = new No_Caducadero(nom, nom, pre,cant);
         nocad1.Calcular(cant);
         nocad1.imprimir();
      }

...
public class Lista_Equipo {
    ...
    public static String concentracion() {
        String res = "";
    ...
    public static String entrenamiento() {
        String res = "";
        for (SeleccionFutbol integrante : ListaSeleccion) {
    ...
    public static String planificarPartido() {
        String res = "";
        for (SeleccionFutbol integrante : ListaSeleccion) {
    ...
    public static String entrevista() {
        String res = "";
        for (SeleccionFutbol integrante : ListaSeleccion) {
